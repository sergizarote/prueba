 ...
 * InsertarActSen.java
 *
 * Created on 27 de abril de 2010, 16:53
 */
...
public class InsertarActSen extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(skoa.views.SkoaApp.class).getContext().getResourceMap(InsertarActSen.class);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jCBSubtipo, 0, 172, Short.MAX_VALUE)
                            .addComponent(jCBTipo, 0, 172, Short.MAX_VALUE)))
                    .addGroup(layout.createSequentialGroup()
...
//                        System.out.println("nombre dispositivo:"+jTFNombre.getText());
                        ...
                        if (SkoaMain.comprueba_planta_estancia(EstanciaCaracteristicas.planta_seleccionada, EstanciaCaracteristicas.estancia_seleccionada) == 0)
                        {
                            // Insertamos el nombre de la planta
                            SkoaMain.vecDispUsados[VariableGlobal.indVDispUsad] = EstanciaCaracteristicas.planta_seleccionada;
                            VariableGlobal.indVDispUsad++;
                            // El nombre de la estancia
                            SkoaMain.vecDispUsados[VariableGlobal.indVDispUsad] = EstanciaCaracteristicas.estancia_seleccionada;
                        ...
                        int pos = SkoaMain.devuelve_pos(EstanciaCaracteristicas.planta_seleccionada, EstanciaCaracteristicas.estancia_seleccionada);
                        int numero = 0;
