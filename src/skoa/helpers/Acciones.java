...
public class Acciones {
     ...
     * @param nombreIcono
     */
    public static void insertaIconos(JLabel insertar, String nombreIcono) {

        String planta = EstanciaCaracteristicas.planta_estancia;
        String estancia = EstanciaCaracteristicas.nombre_estancia;
                            ...
                            if (node2.valueOf("@nombre").equals(estancia)) {
                                ...
                                for (Iterator ib = node3.elementIterator(); ib.hasNext();) {
                                    ...
                                    if (node3.getName().equals("iconos")) {
                                        ...
                                        for (String field : fieldsToInclude) {
                                            if (nombreIcono.equals(field)) {
                                                for (MiFormato miFormato : EstanciaCaracteristicas.parametros) {
     ...
     */
    public static void mostrarPlantasVistaModificarPlano() {
        try {
     ...
     */
    public static void mostrarPlantasVistaEstanciaCaracteristicas() {
        try {
            //remueve los items anteriores
            EstanciaCaracteristicas.desplegable_planta.removeAllItems();
            EstanciaCaracteristicas.desplegable_planta.addItem("--Plantas--");
            ...
            for (Iterator i = node.elementIterator(); i.hasNext();) {
                ...
                if (node.getName().equals("planta") && !node.valueOf("@alias").equals("")) {
                    ...
                    EstanciaCaracteristicas.desplegable_planta.addItem(node.valueOf("@alias"));
                }// end if
            }// end for
    ...
    /**
     * Metodo que carga desde el xml las plantas
     * para mostrarla en la vista eliminarPlanta
     */
    public static void mostrarPlantasVistaEliminarPlanta() {
        try {

            //remueve los items anteriores
            EliminarPlanta.desplegable_planta.removeAllItems();
            EliminarPlanta.desplegable_planta.addItem("--Plantas--");
            ...
            for (Iterator i = node.elementIterator(); i.hasNext();) {
                ...
                if (node.getName().equals("planta") && !node.valueOf("@alias").equals("")) {
                    ...
                    //llamamos la vista para mostralo
                    EliminarPlanta.desplegable_planta.addItem(node.valueOf("@alias"));
     ...
     */
    public static void mostrarPlantasVistaEliminarEstancia() {
        try {
    ...
    /**
     * Metodo que carga desde el xml las plantas
     * para mostrarla en la vista mostrarplantasEliminar
     */
    public static void mostrarPlantasVistaEliminarDispositivos() {
        try {

            //remueve los items anteriores
            EliminarDispositivos.desplegable_planta.removeAllItems();
            EliminarDispositivos.desplegable_planta.addItem("--Plantas--");
            ...
            for (Iterator i = node.elementIterator(); i.hasNext();) {
                ...
                if (node.getName().equals("planta") && !node.valueOf("@alias").equals("")) {
                    ...
                    //llamamos la vista para mostralo
                    EliminarDispositivos.desplegable_planta.addItem(node.valueOf("@alias"));
     ...
     * para mostrarla en la vista EstanciaCaracteristicas
     */
    public static void mostrarEstanciasVistaEstanciaCaracteristicas() {
        try {
            //remueve los items anteriores
            EstanciaCaracteristicas.desplegable_estancia.removeAllItems();
            EstanciaCaracteristicas.desplegable_estancia.addItem("--Estancias--");
            ...
            for (Iterator i = node.elementIterator(); i.hasNext();) {
                ...
                //si es la planta que estoy buscando
                if (node.getName().equals("planta") && node.valueOf("@alias").equals(EstanciaCaracteristicas.planta_seleccionada)) {
                    node2 = node;
                    ...
                    for (Iterator ia = node2.elementIterator(); ia.hasNext();) {
                        ...
                        if (node2.getName().equals("estancia")) {
                            //lo agrego a la vista
                            EstanciaCaracteristicas.desplegable_estancia.addItem(node2.valueOf("@nombre"));
                        }
                    }
     ...
     * para mostrarla en la vista EliminarEstancia
     */
    public static void mostrarEstanciasVistaEliminarEstancia() {
        try {
            //remueve los items anteriores
            EliminarEstancia.desplegable_estancia.removeAllItems();
            EliminarEstancia.desplegable_estancia.addItem("--Estancias--");
            ...
            for (Iterator i = node.elementIterator(); i.hasNext();) {
                ...
                //si es la planta que estoy buscando
                if (node.getName().equals("planta")  && node.valueOf("@alias").equals(EliminarEstancia.planta_seleccionada)) {
                    node2 = node;
                    ...
                    for (Iterator ia = node2.elementIterator(); ia.hasNext();) {
                        ...
                        if (node2.getName().equals("estancia") ) {
                            //lo agrego a la vista
                            EliminarEstancia.desplegable_estancia.addItem(node2.valueOf("@nombre"));
                        }
                    }
     ...
     */
    public static void mostrarEstanciasVistaEliminarDispositivos() {
        try {
            //remueve los items anteriores
            EliminarDispositivos.desplegable_estancia.removeAllItems();
            EliminarDispositivos.desplegable_estancia.addItem("--Estancias--");
            ...
            for (Iterator i = node.elementIterator(); i.hasNext();) {
                ...
                //si es la planta que estoy buscando
                if (node.getName().equals("planta") && node.valueOf("@alias").equals(EliminarDispositivos.planta_seleccionada)) {
                    node2 = node;
                    ...
                    for (Iterator ia = node2.elementIterator(); ia.hasNext();) {
                        ...
                        if (node2.getName().equals("estancia") ) {
                            //lo agrego a la vista
                            EliminarDispositivos.desplegable_estancia.addItem(node2.valueOf("@nombre"));
                        }
                    }
     ...
     * @param estancia
     */
    public static void mostrarDispositivosVistaEliminarDispositivos(String planta, String estancia) {
        try {
            //referencia para leer el archivo
            File aFile = new File(NuevoProyecto.archivo);
                                ...
                                if (node3.getName().equals("iconos")) {
                                    ...
                                    for (Iterator il = labels.elementIterator(); il.hasNext();) {
                                        ...
                                        if (labels.getName().equals("label")) {
                                            ...
                                            EliminarDispositivos.panel_plano.add(insertar, javax.swing.JLayeredPane.DRAG_LAYER);
                                            ...
                                            EliminarDispositivos.panel_plano.add(boton1, javax.swing.JLayeredPane.DRAG_LAYER);
                                            boton1.addActionListener(new ActionListener() {
                                                ...
                                                public void actionPerformed(
                                                    ...
                                                    int num = buscaNum(
                                                            identif,
                                                            tipo,
                                                            EliminarDispositivos.planta_seleccionada,
                                                            EliminarDispositivos.estancia_seleccionada);
     ...
     * @param estancia
     */
    public static void mostrarDispositivosVistaEstanciaCaracteristicas(String planta, String estancia) {
        try {
            //referencia para leer el archivo
            File aFile = new File(NuevoProyecto.archivo);
                                ...
                                if (node3.getName().equals("iconos")) {
                                    ...
                                    for (Iterator il = labels.elementIterator(); il.hasNext();) {
                                        ...
                                        if (labels.getName().equals("label")) {
                                            ...
                                            //lo inserta en la vista principal
                                            EstanciaCaracteristicas.panel_plano.add(insertar, javax.swing.JLayeredPane.DRAG_LAYER);
    ...
    public static void eliminarDispositivoVistaEliminarDispositivos(String identificador) {
        try {
            ...
            //++++++++++++++       MENSAJE ALERTA 
            String mostrar = "Dispositivo Eliminado";
            JOptionPane.showMessageDialog(null, mostrar, "Información", 1);
            ...
            for (int indice = 0; indice < componentes.length; indice++) {
                ...
                if (name != null) {
                    if (name.equals("regulacion")
                        ...
                        EliminarDispositivos.panel_plano.remove(componentes[indice]);
                        EliminarDispositivos.panel_plano.moveToBack(componentes[indice]);
                    } //end if
                }
            }//end for
     ...
     * @param numPlantas
     */
    public static void rellenaVect(EstanciaGenerica[] vecEstancias,
            javax.swing.JTabbedPane[] vectpPlantas, int[] numPlantas) {
